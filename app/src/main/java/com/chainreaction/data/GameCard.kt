...
object CardDeck {
    val ALL: List<GameCard> = listOf(
        ...
        GameCard(58, "After throw", CardKind.ATTACK, "I Think It's Broke", "Play on another player that just hit a tree. They lose that disc — they can't throw it again for the rest of the round."),
