...
object CardDeck {
    val ALL: List<GameCard> = listOf(
        ...
        GameCard(20, "After throw", CardKind.DUAL, "Doesn't Look OB to Me", "Play on a shot that just went OB. Instead of actually being OB (or in a hazard) it can just be played where it lies, with no penalty at all."),
