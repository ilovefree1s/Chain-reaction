...
object CardDeck {
    val ALL: List<GameCard> = listOf(
        ...
        GameCard(20, "Before tee shot", CardKind.ATTACK, "Do Not Pass Go", "Whoever has the shortest drive on the next hole gets no free mulligan while everyone else does."),
        ...
        GameCard(51, "Before tee shot", CardKind.ATTACK, "Too Many Choices", "Pick 3 discs out of an opponent's bag. They pick 1, then pass the other 2 to the next person, who chooses 1 of the 2 and gives the last disc to the last person. Tee off, nerds."),
        ...
        GameCard(62, "Before tee shot", CardKind.ATTACK, "DESTINATION FUCKED!", "Force an opponent to play the entire hole with the... slightly used Anax..."),
    )
