...
object CardDeck {
    val ALL: List<GameCard> = listOf(
        ...
        GameCard(7, "Before shot", CardKind.ATTACK, "Bag Raid!", "Choose ANY disc that belongs to anyone. The target player must use that disc for their next shot. (Not the TILT or the beater.)"),
        GameCard(8, "After throw", CardKind.ATTACK, "Big Ooof, Bud.", "Move an opponent's lie up to 10 steps in any direction, as long as it isn't out of bounds."),
        ...
        GameCard(19, "After throw", CardKind.SELF, "Do Not Pass Go", "Play after everyone tees — if you have the shortest drive, throw your 2nd shot with the person that had the farthest drive."),
        ...
        GameCard(38, "Any time", CardKind.DUAL, "Not Today!", "Remove any and all card effects currently on you, or use it on another player to cancel the effects on them."),
        GameCard(39, "Before tee shot", CardKind.ATTACK, "One Disc Wonder!", "Force an opponent to play the hole with only 1 DISC (your choice from their bag, unless someone already gave them THE CURD!, the TILT or the \"beater\", which counts as their 1 disc)."),
        ...
        GameCard(43, "After throw", CardKind.ATTACK, "Prove It", "Cancel a shot an opponent just took. They throw again with a different disc of YOUR choice from any bag (not the TILT or the beater). The extra throw counts as a stroke."),
        ...
        GameCard(54, "Before tee shot", CardKind.ATTACK, "Your Tee Pad Is Over There!", "Take up to 10 steps off the regular tee pad and put a disc down to mark a new tee pad for everyone else. They all tee from it."),
        ...
        GameCard(64, "Any time", CardKind.GROUP, "Everyone Draws!", "Everyone but the exempt player draws a card."),
    )
