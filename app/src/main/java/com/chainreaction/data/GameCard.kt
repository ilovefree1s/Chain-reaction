...
object CardDeck {
    val ALL: List<GameCard> = listOf(
        ...
        GameCard(35, "Before tee shot", CardKind.DUAL, "Lefty Off the Box", "Allow a player to tee off left handed for free. Their first throw after that is their real tee shot."),
        ...
        GameCard(51, "Before shot", CardKind.DUAL, "That's Definitely a Gimme", "Allow a player to pick up a putt as a gimme, as long as it's inside C1. They definitely woulda made it."),
