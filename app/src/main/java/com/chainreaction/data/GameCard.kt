...
object CardDeck {
    val ALL: List<GameCard> = listOf(
        ...
        GameCard(13, "Any time", CardKind.REACT, "Change Is Good", "Hijack a card as it's played and re-aim it at the player of your choice — including the player who played it."),
        ...
        GameCard(20, "After throw", CardKind.DUAL, "Doesn't Look OB to Me", "Play on a shot that just went OB. Instead of actually being OB (or in a hazard) they can just play it where it lies, with no penalty at all."),
        ...
        GameCard(33, "Before tee shot", CardKind.DUAL, "Lefty ON the Box", "Your first throw off the box is with your offhand, for free — that's throw 0. The player in last place gets it too. If 2 players are tied for last, they rock paper scissors for it."),
        ...
        GameCard(39, "Before tee shot", CardKind.ATTACK, "One Disc Wonder!", "Force an opponent to play the hole with only 1 DISC this hole! (If someone already gave them a mini, the TILT or the Anax, that counts as their 1 disc.)"),
        ...
        GameCard(43, "After throw", CardKind.ATTACK, "Prove It", "Cancel a shot an opponent just took. They throw again with a different disc of their choice from any bag. (No extra stroke, just a forced mulligan.)"),
        ...
        GameCard(48, "Before shot", CardKind.DUAL, "That's Definitely a Gimme", "Pick up a putt as a gimme, as long as it's inside C1 — you definitely woulda made it. The player in last place gets one too. If 2 players are tied for last, they rock paper scissors for it."),
        ...
        GameCard(60, "Before tee shot", CardKind.ATTACK, "DESTINATION FUCKED!", "Force an opponent to play the entire hole with the... slightly used Anax... Whoever played the card gets 30 seconds to abuse the disc before they tee off."),
    )
