...
object CardDeck {
    val ALL: List<GameCard> = listOf(
        ...
        GameCard(38, "Before tee shot", CardKind.GIFT, "Lefty Off the Box", "Allow a player to tee off left handed for free. Their first throw after that is their real tee shot."),
