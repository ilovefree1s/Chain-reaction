...
object Rules {
    ...
    val WHEEL_EXCLUDES = setOf(4, 6, 9, 15, 16, 21, 22, 23, 24, 25, 26, 27, 30, 32, 33, 35, 38, 40, 42, 44, 47, 49, 54, 58)
...
object CardDeck {
    val ALL: List<GameCard> = listOf(
        GameCard(1, "Before tee shot", CardKind.SELF, "1v1 Challenge", "Challenge someone. It runs until one of you beats the other's score on a hole — a tie settles nothing. The winner gets a free immunity hole and 1 free mulligan on that hole."),
        ...
        GameCard(8, "Before shot", CardKind.ATTACK, "Bag Raid!", "Choose ANY disc from any bag. That disc must be used on their next shot."),
        ...
        GameCard(10, "After throw", CardKind.ATTACK, "Big Ooof, Bud.", "Move an opponent's lie 10 paces (30 ft) in any direction, as long as it isn't out of bounds."),
        GameCard(11, "After throw", CardKind.SELF, "Big Putt!", "If you make a putt from outside C1 while a player still to putt is inside C1, they have to putt with their off hand."),
        ...
        GameCard(26, "Any time", CardKind.ATTACK, "Finders Keepers", "If you pick up a disc a player forgot, play this to keep it for the rest of the round. You have to hold it for a full hole without them asking about it."),
        ...
        GameCard(28, "After throw", CardKind.SELF, "Foot Wedge!", "Move your own lie 10 paces (30 ft) in any direction."),
        ...
        GameCard(37, "Before tee shot", CardKind.GIFT, "Lefty Off the Box", "Allow a player to tee off left handed for free. Their first throw after that is their real tee shot."),
        ...
        GameCard(39, "Before tee shot", CardKind.SELF, "My Tee Pad Is Over Here!", "Use 2 of your discs to mark a new tee for yourself, within 10 paces (30 ft) of the original. Feeling nice? You may pick 1 player to join you."),
        ...
        GameCard(50, "Before shot", CardKind.DUAL, "Shoe Golf", "On yourself: putt with your own shoe at no stroke cost. On another player: they putt with a shoe and it still counts as a stroke."),
        GameCard(51, "Before shot", CardKind.ATTACK, "Sidearm", "Force an opponent to throw a sidearm on the upcoming drive or approach."),
        GameCard(52, "Before shot", CardKind.DUAL, "Spin to Win", "Spin rapidly 10 times, then putt within 3 seconds. Free on yourself, a normal stroke on an opponent."),
        GameCard(53, "Before shot", CardKind.GIFT, "That's Definitely a Gimme", "Allow a player to pick up a putt as a gimme, as long as it's inside C1. They definitely woulda made it."),
        ...
        GameCard(60, "Before tee shot", CardKind.ATTACK, "Your Tee Pad Is Over There!", "Use 2 of your discs to mark a new tee for an opponent of your choice, within 10 paces (30 ft) of the original. They tee from it."),
    )
