...
by unit test (`deck is 61 cards with unique ids one through 61`).
...
7. **The wheel costs cards.** The Rules screen has always said "discard 61 cards to buy a
...
The "max 61 cards on one player per hole" rule is shown on the Rules screen and tracked by the
players, not the app.
