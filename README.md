...
by unit test (`deck is 59 cards with unique ids one through 59`).
...
The "max 2 attack cards on one player per hole" rule is shown on the Rules screen and tracked by the
players, not the app.
