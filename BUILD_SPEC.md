...
```json
{
  ...
  "wheelExcludes": [7, 8, 11, 12, 13, 15, 18, 19, 27, 31, 36, 37, 39, 43, 48],
  "timings": [
    "Before shot",
    "Before tee shot",
    "After throw",
...
- Spin the Double Wheel 30 times → no blacklisted card (7, 8, 11, 12, 13, 15, 18, 19, 27, 31, 36, 37, 39, 43, 48) ever appears.
