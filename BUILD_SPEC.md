...
```json
{
  ...
  "cards": [
    ...
    { "id": 35, "timing": "Before tee shot", "kind": "self", "rarity": "uncommon", "name": "My Tee Pad Is Over Here!", "text": "Use 2 of your discs to mark a new tee for yourself, up to 10 paces (30 ft) from the original. Feeling nice? You may pick 1 player to join you." },
