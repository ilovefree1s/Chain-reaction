...
```json
{
  ...
  "cards": [
    ...
    { "id": 51, "timing": "Before shot", "kind": "dual", "name": "That's Definitely a Gimme", "text": "Allow a player to pick up a putt as a gimme, as long as it's inside C1. They definitely woulda made it." },
