...
```json
{
  ...
  "wheelCost": 2,
  "freeSpinCard": 25,
  "wheelExcludes": [1, 4, 6, 7, 9, 11, 14, 15, 16, 21, 22, 23, 24, 25, 26, 27, 30, 32, 33, 34, 35, 38, 40, 42, 44, 47, 49, 52, 54, 55, 58, 61],
  "timings": [
    "Before shot",
    "Before tee shot",
    "Before all tee",
  ...
  "cards": [
    ...
    { "id": 28, "timing": "After throw", "kind": "self", "name": "Foot Wedge!", "text": "Move your own lie up to 10 paces (30 ft) in any direction." },
    ...
    { "id": 37, "timing": "Before tee shot", "kind": "dual", "name": "Lefty Off the Box", "text": "Allow a player to tee off left handed for free. Their first throw after that is their real tee shot." },
    ...
    { "id": 56, "timing": "Before shot", "kind": "attack", "name": "Trust Me Bro", "text": "Give another player advice for their tee shot. They have to follow it as best they can. (Somewhat reasonable advice — don't tell them something like throw it backwards.)" },
    { "id": 57, "timing": "Before shot", "kind": "attack", "name": "Turbo Time", "text": "All opponents in C1 must turbo putt their next shot." },
    ...
    { "id": 59, "timing": "After throw", "kind": "attack", "name": "Walk of Shame", "text": "After a missed putt inside C1, that player carries their putter in either hand until they finish the next hole. (They can putt with it.) If they drop it or put it in the bag, +1 stroke." },
    { "id": 60, "timing": "Before tee shot", "kind": "attack", "name": "Your Tee Pad Is Over There!", "text": "Use 2 of your discs to mark a new tee for an opponent of your choice, up to 10 paces (30 ft) from the original. They tee from it." },
    { "id": 61, "timing": "Before all tee", "kind": "sabotage", "name": "I Think It's Broke", "text": "The first player to hit a tree loses that disc — they can't throw it again for the rest of the round." }
  ]
}
```
