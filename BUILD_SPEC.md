...
```json
{
  ...
  "cards": [
    ...
    { "id": 9, "timing": "After throw", "kind": "self", "rarity": "rare", "name": "Big Putted!", "text": "If you make a putt from outside C1 while any other players are inside C1, they all must use their left hand to putt this hole." },
    ...
    { "id": 20, "timing": "After throw", "kind": "dual", "name": "Doesn't Look OB to Me", "text": "Play on a shot that just went OB. Instead of actually being OB (or in a hazard) it can just be played where it lies, with no penalty at all." },
