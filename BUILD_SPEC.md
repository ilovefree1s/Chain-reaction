...
```json
{
  ...
  "cards": [
    ...
    { "id": 39, "timing": "Before tee shot", "kind": "attack", "rarity": "uncommon", "name": "One Disc Wonder!", "text": "Force an opponent to play the hole with only 1 DISC this hole! (If someone already gave them a mini, THE CURD! or the \"beater\", that counts as their 1 disc.)" },
