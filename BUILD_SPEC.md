...
```json
{
  ...
  "cards": [
    ...
    { "id": 27, "timing": "After all tee", "kind": "self", "rarity": "epic", "name": "I'll Have What He's Having", "text": "After all tee shots, trade lies with an opponent of your choice. The player whose lie you take can join another player of their choice instead of switching with the person that played the card." },
