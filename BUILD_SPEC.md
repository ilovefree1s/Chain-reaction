...
```json
{
  ...
  "cards": [
    ...
    { "id": 7, "timing": "Before shot", "kind": "attack", "name": "Bag Raid!", "text": "Choose ANY disc that belongs to anyone. The target player must use that disc for their next shot." },
