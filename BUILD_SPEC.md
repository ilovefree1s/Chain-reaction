...
```json
{
  ...
  "cards": [
    ...
    { "id": 35, "timing": "Before tee shot", "kind": "self", "rarity": "uncommon", "name": "My Tee Pad Is Over Here!", "text": "Use 2 of your discs to mark a new tee for yourself, up to 10 paces (30 ft) from the original. You must pick 1 player to join you — anyone but whoever is in 1st." },
    ...
    { "id": 39, "timing": "Before tee shot", "kind": "attack", "rarity": "uncommon", "name": "One Disc Wonder!", "text": "Force an opponent to play the hole with only 1 DISC this hole! (If someone already gave them THE CURD!, the TILT or the \"beater\", that counts as their 1 disc.)" },
