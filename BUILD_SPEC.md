...
```json
{
  ...
  "cards": [
    ...
    { "id": 16, "timing": "Before tee shot", "kind": "attack", "rarity": "uncommon", "name": "Code Words!", "text": "An opponent can't say \"yes\" or \"no\" this hole. 1 stroke penalty every time they do. ANY variation of the words yes or no counts. (Once their disc is in the basket the hole is over.)" },
