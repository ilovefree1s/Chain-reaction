...
const PAGE_CACHE = "chainreaction-page-caf2e0e7d897";
const ASSET_CACHE = "chainreaction-assets-5673d605a765";
const PAGE_FILES = [
  "./",
  "index.html",
...
const ASSET_FILES = [
  ...
  "assets/navhand.png",
  "assets/navscore.png",
  "assets/fortheboys.png",
  "assets/cardback.png",
  "assets/sgbg.png",
  "assets/sgbuttons.png",
  "assets/gamblewheel.png",
  "assets/spinbuttons.png",
  "assets/paybuttons.png",
  "assets/confirmbuttons.png",
  "assets/namebutton.png",
  "assets/facebuttons.png",
  "assets/chains.mp3",
  "assets/gamble.mp3",
  "assets/lonewolf.mp3",
  "assets/draw.wav",
  "assets/dice.mp3",
  "assets/shuffle.wav",
  "assets/discgolferbeeotch.mp3",
  "assets/dischoarderblues.mp3",
  "assets/chainsofglory.mp3",
