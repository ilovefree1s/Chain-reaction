...
const SETTLED = {
  ...
  3: "Fine as-is. Attack on one player — heckle first, name the target when you play it after.",
  4: "Fine as-is. Attack on one player.",
  5: "Fine as-is. Attack on one player.",
  7: "Fine as-is. Attack on one player.",
  8: "Fine as-is. Attack on one player.",
  10: "Fine as-is. Attack on one player.",
  12: "Fine as-is — wording already rewritten. Attack on one player: the one whose hand you raid.",
  14: "Fine as-is. Attack on one player.",
  15: "Fine as-is. Attack on one player.",
  16: "Fine as-is. Attack on one player.",
  18: "Fine as-is. Whole table — All players picker.",
  19: "Now whole table — All players picker. Everyone is in the running until the drives land; only the shortest one actually loses their cards.",
  17: "Renamed Commentator → Jomez Commentator (also updated where the rules list score-rewriting cards). Targeting and text unchanged: attack on one player.",
  6: "Targeting fine. Wording extended: the lie swap is now owed “the next time they go OB or miss a mando.”",
  9: "Whole table — All players picker. Alert says: “You just got Big Putted, nerd. Now you putt this as a lefty. If you already made it, never mind — but you're still a nerd.”",
  11: "Whole table — All players picker. Announces the call to everyone.",
  20: "Fine as-is. Dual — the favour can land on you or on somebody else.",
  48: "Dual, unchanged targeting. Reworded to match Lefty ON the Box: second person, and the player in last place gets a gimme too, rock paper scissors settling a tie for last.",
  45: "Fine as-is. Dual — self or another player, and the wheel's good/bad spin applies: it can land there and spells out both halves.",
  42: "Fine as-is. Dual — self or another player, and one of the few cards the wheel's good/bad spin actually applies to, since it can land there and spells out both halves.",
  34: "Fine as-is. Dual — self or any other player. Good-vs-bad is table convention only: the app never applies scores, and the one mechanical use of the distinction (the wheel's good/bad spin) can't reach this card because it is wheel-excluded.",
  33: "Dual, unchanged targeting. Rewritten: the free offhand tee shot is named — throw 0 — and the player in last place gets one too, rock paper scissors settling a tie for last.",
  28: "Fine as-is. Dual — picker offers the table plus Myself, and the wheel's good/bad spin applies since it spells out both halves.",
  25: "Fine as-is. Self card, no target.",
  27: "Renamed Gimme Dat → “I'll Have What He's Having.” Text unchanged. NOTE: still kind self, so it plays with no picker — but it trades lies with an opponent of your choice, the same shape as 1v1 Challenge, which moved to attack.",
  30: "Fine as-is. Self card, no target.",
  35: "Fine as-is. Self card, no target.",
  50: "Fine as-is. Self card, no target.",
  38: "Kind changed self → dual, and the text with it: clear the effects on you, or use it on another player to clear theirs. Picker offers the table plus Myself.",
  26: "Fine as-is. Self card, no target.",
  21: "Self card, no target — stays that way. Any form of “nice” now counts, and the payout moved: walk to where the disc landed and throw again free, instead of replaying the throw.",
  23: "One player, locked in — and the table gets a blue “join in!” invite to help distract them.",
  24: "Whole table — All players picker. Alert says: “Everyone else owes 5 dollars to the ace pot!”",
  29: "Kind changed self → gift → dual. The team-up is agreed out loud, so the card just records who accepted: one player, no “Myself” button. Teammate reads “You're teammates next hole”; the table sees who got picked.",
  31: "Fine as-is. Whole table — All players picker.",
  32: "Fine as-is. Attack on one player.",
  40: "Fine as-is. Whole table — All players picker.",
  44: "Fine as-is. Attack on one player.",
  55: "Now whole table — All players picker. Everyone else tees from the new spot you mark.",
  54: "Targeting fine (attack on one player). Wording pins down the details: either hand, and yes they can putt with it.",
  52: "Now whole table — All players picker. Every opponent inside C1 turbo putts their next shot.",
  51: "Targeting fine (attack on one player). Added the guard rail: somewhat reasonable advice — no “throw it backwards.”",
  49: "Simplified 2026-08-30 in the user's words to a one-opponent attack (off the PLAY_ON_ALL list): pick 2 discs out of 1 person's bag, they choose 1 to tee off with. Mirrors the wheel version, scaled down to one bag.",
  46: "Renamed Sidearm → “Forehand only!”, and the text follows it: throw a forehand, not a sidearm. Targeting unchanged.",
  43: "Targeting fine (attack on one player). Wording widened: the replacement disc can come from any bag, and it is spelled out as a forced mulligan with no stroke.",
  41: "Now whole table — All players picker, retimed to Before all tee. Text: “No run-up on everyone else's tee shot.”",
  39: "Targeting fine (attack on one player). Wording now covers the overlap case: a disc someone else forced on them — an Aerobie or a mini — counts as their one disc.",
  37: "Renamed Not the Recommended Route → “New mando on this hole, bud.” Targeting and text unchanged: attack on one player.",
  56: "Whole table — All players picker.",
  57: "Added 2026-08-26 by the user's design. A reaction like No Way: plays with no target — whoever it bounces back at is obvious at the table. Doesn't work on wheel spins by its own text.",
  58: "Added 2026-08-26 by the user's design. The first WHEEL-ONLY card: never shuffled into a deck, so it has no play targeting at all — it exists purely as a wheel landing.",
  59: "Added 2026-08-28 by the user's design, promoted to a regular deck card 2026-08-29 as PUT EM ON TILT: in hand it's an attack you aim at an opponent; off the wheel it still lands on whoever bought the spin.",
  60: "Added 2026-08-29 by the user's design, cut from the same cloth as PUT EM ON TILT: an attack you aim at an opponent, who plays the entire hole with the slightly used Anax.",
  53: "Fine as-is. No target — the race is the announcement, and everyone at the table is in it.",
  47: "Fine as-is. No target — it fires the moment it's drawn, and the table still sees the play land in everyone's alerts.",
  22: "Fine as-is. No target — playing it opens the wheel for a free spin, and the spin itself already alerts every phone at the table.",
  36: "Fine as-is. Reaction, no target — it answers whatever card was just played, so the app has nothing to ask.",
  13: "Now opens the one-player picker, the first reaction that does. Reworded as theft: you hijack the card as it's played and re-aim it at whoever you choose, the player who played it included. Kind stays react.",
};
...
const WHEEL_SETTLED = {
  ...
  3: "Stays off the wheel. Playable from a hand only.",
  5: "Stays off the wheel. Playable from a hand only.",
  6: "Stays off the wheel. Playable from a hand only.",
  19: "Stays off the wheel. Playable from a hand only.",
  23: "Stays off the wheel. Playable from a hand only.",
  31: "Stays off the wheel. Playable from a hand only.",
  43: "Stays off the wheel. Playable from a hand only.",
  21: "Stays off the wheel. Playable from a hand only.",
  24: "Stays off the wheel. Playable from a hand only.",
  20: "Stays off the wheel. Playable from a hand only.",
  34: "Stays off the wheel. Playable from a hand only.",
  38: "Stays off the wheel. Playable from a hand only.",
  13: "Stays off the wheel. Playable from a hand only.",
  36: "Stays off the wheel. Playable from a hand only.",
  53: "Stays off the wheel. Playable from a hand only.",
  47: "Stays off the wheel. It plays itself the moment you draw it.",
  56: "Stays off the wheel. Playable from a hand only.",
  57: "Stays off the wheel, like the other reaction cards — it has nothing to react to when drawn this way.",
  58: "WHEEL-ONLY, in the user's words. The wolf isn't sitting anything out, so it reads as its own text with no exempt banner (SAYS_IT_ALL).",
  59: "On the wheel it keeps its own words with [spinner] filled in: “[spinner] spun the wheel and has to play the entire hole with the TILT!” No exempt banner (SAYS_IT_ALL) — the spun name has nothing to do with this one.",
  60: "On the wheel it lands like PUT EM ON TILT: “[spinner] spun the wheel and has to play the entire hole with the... slightly used Anax...” No exempt banner (SAYS_IT_ALL).",
  12: "Renamed Can I Borrow This? → \"Can I Borrow This Card?\" Stays off the wheel. Playable from a hand only.",
  2: "On the wheel: straddle putting starts once you're inside Circle 2, and runs for every putt from there.",
  50: "Joins the wheel. Free tree insurance for everyone but the exempt player, with the payout spelled out since the wheel shows this instead of the card's own words.",
  35: "On the wheel: everyone but the exempt player builds their own tee pad. Kept the 10 paces; dropped the 2-disc marker, which is the hand version's detail.",
  30: "Joins the wheel. Metal counts as in for everyone but the exempt player, all hole.",
  27: "Joins the wheel, and lands the other way round: the spun name is the only player who gets it and everyone else watches. The screen says \"Lucy gets this one\" rather than naming her as exempt.",
  26: "On the wheel it stops being optional: miss your first putt and you're gambling, exempt player aside. The terms are spelled out rather than referred to, since the wheel shows this text instead of the card's own.",
  25: "On the wheel: everyone but the exempt player gets one free lie move this hole.",
  48: "On the wheel: everyone but the exempt player gets one C1 gimme this hole. The last-place rider is a hand-version thing and stays there.",
  45: "On the wheel it turns into an option rather than a punishment: everyone but the exempt player may take a free shoe putt inside C2. No halves left, so the good/bad spin drops off it.",
  42: "Off the wheel. Playable from a hand only, and its wheel wording is deleted with it.",
  33: "Renamed Lefty Off the Box → \"Lefty ON the Box\". On the wheel it splits like Globetrotter: the spun name gets the offhand throw free as throw 0, everyone else throws lefty and wears it as throw 1.",
  29: "Joins the wheel with a mechanic of its own: after the card lands the wheel spins a SECOND name, and those two play the hole as a team against everybody else. Birdie counts as an eagle, no birdie or better is +1 stroke after the hole, cards on either teammate count against both. The refuse-and-everyone-discards clause is gone from the card entirely. 2026-08-29: the winning team banks a mulligan each (duo's score vs. the other side's best, tie = no prize) — the user wanted the win itself to pay.",
  28: "On the wheel it stands alone: no header over it, no summing-up under it. The card names the spun player, says everyone else still putts behind the back for a regular stroke, and pins it to Circle 1.",
  11: "Joins the wheel, nobody exempt: the whole table throws for CTP and the winner takes the immunity plus a table-wide attack card.",
  9: "Joins the wheel, and lets nobody off: the first player to make a putt sets it going, so the spun name means nothing. The screen says \"Nobody sits this one out\" instead of naming somebody.",
  22: "Renamed Double Wheel → GAMBLE WHEEL!!, everywhere it appears — card, buttons, rules screen, spec.",
  55: "On the wheel: the exempt player marks the new tee and everyone else plays off it. No 2-disc requirement — that's the hand version.",
  54: "On the wheel: it sits on the whole table but only bites whoever misses inside C1 — the exempt player is safe either way.",
  52: "On the wheel: no C1 limit — everyone but the exempt player turbo putts their next putt from wherever they are.",
  51: "On the wheel: the exempt player advises every other player, and can give each of them something different.",
  49: "Reworded on the wheel 2026-08-29 in the user's words: the exempt player picks 2 discs out of each person's bag, and everyone picks 1 of the 2 to tee off with.",
  46: "On the wheel: everyone but the exempt player throws forehand.",
  44: "On the wheel: everyone but the exempt player rolls their drive or approach.",
  41: "On the wheel: everyone but the exempt player is planted for the next tee shot.",
  40: "Joins the wheel. The exempt player hands out discs from their own bag and everyone else tees with them.",
  39: "On the wheel: the exempt player puts everyone else on one disc, and a disc forced on them by another card still counts as that one.",
  37: "Reworded on the wheel 2026-08-30 in the user's words: the exempt player chooses a somewhat reasonable mando for THIS hole and everyone else plays it. (Was next-hole out of caution about mid-hole spins; the user moved it back to the live hole.)",
  32: "On the wheel: everyone but the exempt player drives off hand.",
  18: "Joins the wheel — first card taken off the blacklist. The exempt player picks the disc everyone else tees with. Close to Bag Raid on the wheel, but from your own bag and this hole rather than the next.",
  17: "On the wheel: it flips — the exempt player is the one being commentated, and everyone else has to call their shots. Written as \"anyone who forgets\" rather than \"any one of the 3\", since the table can be 3, 4 or 5.",
  16: "On the wheel, reworded 2026-08-29 in the user's words: nobody says YES or NO, any variation counts (yea, yep, nah, etc.), +1 stroke per slip, doesn't apply to [exempt], obviously.",
  15: "On the wheel: everyone but the exempt player takes their next putt with their eyes closed.",
  14: "On the wheel: everyone but the exempt player throws a tomahawk on their drive or approach.",
  10: "On the wheel: worded \"everyone but [exempt]\" outright. That split the token in two — [chooser] for whoever makes the picks, [exempt] for whoever is sitting out — since a free spin has a spinner but no exempt player.",
  8: "On the wheel: the exempt player moves every other player's next lie, up to 10 paces, still not out of bounds.",
  7: "On the wheel: the exempt player picks a disc out of any bag for each other player, and it's their tee shot on the next hole — not the next throw, so the whole table is on the same shot.",
  4: "On the wheel: it rides until you've thrown one or the other, since a spin can land mid-hole with some players already off the tee and others still putting.",
};
