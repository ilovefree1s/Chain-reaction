...
const SETTLED = {
  ...
  61: "Added 2026-08-28 by the user's design. WHEEL-ONLY and the first spinner-punish card: it lands on whoever bought the spin, nobody else.",
...
const WHEEL_SETTLED = {
  ...
  61: "WHEEL-ONLY, in the user's words with [spinner] filled in: “[spinner] spun the wheel and has to play the entire hole with the TILT!” No exempt banner (SAYS_IT_ALL) — the spun name has nothing to do with this one.",
