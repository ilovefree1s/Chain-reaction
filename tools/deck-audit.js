...
const SETTLED = {
  ...
  47: "Dual, unchanged targeting. Reworded to match Lefty ON the Box: second person, and the player in last place gets a gimme too, rock paper scissors settling a tie for last.",
  ...
  49: "Fine as-is. Self card, no target.",
  ...
  54: "Now whole table — All players picker. Everyone else tees from the new spot you mark.",
  53: "Targeting fine (attack on one player). Wording pins down the details: either hand, and yes they can putt with it.",
  51: "Now whole table — All players picker. Every opponent inside C1 turbo putts their next shot.",
  50: "Targeting fine (attack on one player). Added the guard rail: somewhat reasonable advice — no “throw it backwards.”",
  48: "Simplified 2026-08-30 in the user's words to a one-opponent attack (off the PLAY_ON_ALL list): pick 2 discs out of 1 person's bag, they choose 1 to tee off with. Mirrors the wheel version, scaled down to one bag.",
  ...
  55: "Whole table — All players picker.",
  56: "Added 2026-08-26 by the user's design. A reaction like No Way: plays with no target — whoever it bounces back at is obvious at the table. Doesn't work on wheel spins by its own text.",
  57: "Added 2026-08-26 by the user's design. The first WHEEL-ONLY card: never shuffled into a deck, so it has no play targeting at all — it exists purely as a wheel landing.",
  58: "Added 2026-08-28 by the user's design, promoted to a regular deck card 2026-08-29 as PUT EM ON TILT: in hand it's an attack you aim at an opponent; off the wheel it still lands on whoever bought the spin.",
  59: "Added 2026-08-29 by the user's design, cut from the same cloth as PUT EM ON TILT: an attack you aim at an opponent, who plays the entire hole with the slightly used Anax.",
  52: "Fine as-is. No target — the race is the announcement, and everyone at the table is in it.",
...
const WHEEL_SETTLED = {
  ...
  52: "Stays off the wheel. Playable from a hand only.",
  55: "Stays off the wheel. Playable from a hand only.",
  56: "Stays off the wheel, like the other reaction cards — it has nothing to react to when drawn this way.",
  57: "WHEEL-ONLY, in the user's words. The wolf isn't sitting anything out, so it reads as its own text with no exempt banner (SAYS_IT_ALL).",
  58: "On the wheel it keeps its own words with [spinner] filled in: “[spinner] spun the wheel and has to play the entire hole with the TILT!” No exempt banner (SAYS_IT_ALL) — the spun name has nothing to do with this one.",
  59: "On the wheel it lands like PUT EM ON TILT: “[spinner] spun the wheel and has to play the entire hole with the... slightly used Anax...” No exempt banner (SAYS_IT_ALL).",
  ...
  49: "Joins the wheel. Free tree insurance for everyone but the exempt player, with the payout spelled out since the wheel shows this instead of the card's own words.",
  ...
  47: "On the wheel: everyone but the exempt player gets one C1 gimme this hole. The last-place rider is a hand-version thing and stays there.",
  ...
  54: "On the wheel: the exempt player marks the new tee and everyone else plays off it. No 2-disc requirement — that's the hand version.",
  53: "On the wheel: it sits on the whole table but only bites whoever misses inside C1 — the exempt player is safe either way.",
  51: "On the wheel: no C1 limit — everyone but the exempt player turbo putts their next putt from wherever they are.",
  50: "On the wheel: the exempt player advises every other player, and can give each of them something different.",
  48: "Reworded on the wheel 2026-08-29 in the user's words: the exempt player picks 2 discs out of each person's bag, and everyone picks 1 of the 2 to tee off with.",
